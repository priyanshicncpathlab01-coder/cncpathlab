...
const biovideo = '/assets/biovideo.mp4';
const bioimage = '/assets/bioimage.webp';
const labimage = '/assets/labimage.webp';
const earlyphase = '/assets/images/earlyphase.webp';
